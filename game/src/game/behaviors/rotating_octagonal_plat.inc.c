...
void bhv_rotating_octagonal_plat_init(void) {
    o->collisionData = segmented_to_virtual(WORLD(sOctagonalPlatformCollision)[(o->oBhvParams >> 16) & 0xFF]);
    o->oAngleVelYaw = WORLD(sOctagonalPlatformAngularVelocities)[(o->oBhvParams >> 24) & 0xFF];
}
