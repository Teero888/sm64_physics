...
extern struct MovtexQuadCollection jrb_movtex_water[];
extern struct MovtexQuadCollection jrb_movtex_initial_mist[];
...
extern struct MovtexQuadCollection jrb_movtex_sunken_ship_water[];
